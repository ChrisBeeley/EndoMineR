...
library(pander)
pander(head(TheOGDReportFinal,1))
```
...
The parameters indicate whether you want to get rid of Negative phrases from your text ```r NegEx="TRUE"``` and which Extractor you want to use (1 means you know the subtitles are always in the same order, 2 means they are sometimes missing)
<br>
